...
internal object LorenIpsumGenerator {
    ...
    fun generateSentence(): String =
        generate(count = Random.Default.nextInt(1, 15))
            .joinToString(
                separator = " ",
    ...
    fun generateTime(): String {
        val hours = Random.Default.nextInt(0, 23).toString().padStart(2, '0')
        val minutes = Random.Default.nextInt(0, 59).toString().padStart(2, '0')
